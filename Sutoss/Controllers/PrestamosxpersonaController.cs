...
namespace Sutoss.Controllers
{
    [Route("[controller]")]
    [ApiController]
    public class PrestamosxpersonasController : ControllerBase
    {
        private readonly ILogger<PrestamosxpersonasController> _logger;
        private readonly IPrestamosxpersonasService _service;

        public PrestamosxpersonasController(ILogger<PrestamosxpersonasController> logger, IPrestamosxpersonasService service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        public async Task<IActionResult> Update(PrestamosxpersonaRequest Prestamosxpersona)
        {
            try
            {
                return Ok(await _service.Update(Prestamosxpersona  ));
            }
            catch (NotFoundException ex)
            {
                // Logger.Warn(ex);
