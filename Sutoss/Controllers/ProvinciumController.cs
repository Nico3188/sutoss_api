...
namespace Sutoss.Controllers
{
    ...
    public class ProvinciaController : ControllerBase
    {
        ...
        public ProvinciaController(ILogger<ProvinciaController> logger, IProvinciaService service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        [HttpPost("Create")]
        [Authorize]
        public async Task<IActionResult> Create(ProvinciumRequest newProvincium)
        {
            try 
            {
                return Ok(await _service.Create(newProvincium  ));
            }
            catch (NotFoundException ex)
            {
                // Logger.Warn(ex);
        ...
        [HttpPut("Update")]
        [Authorize]
        public async Task<IActionResult> Update(ProvinciumRequest Provincium)
        {
            try
            {
                return Ok(await _service.Update(Provincium  ));
            }
            catch (NotFoundException ex)
            {
                // Logger.Warn(ex);
