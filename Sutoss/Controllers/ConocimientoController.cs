...
namespace Sutoss.Controllers
{
    ...
    {
        private readonly ILogger<ConocimientosController> _logger;
        private readonly IConocimientosService _service;

        public ConocimientosController(ILogger<ConocimientosController> logger, IConocimientosService service)
        {
            _logger = logger;
            _service = service;
        }
