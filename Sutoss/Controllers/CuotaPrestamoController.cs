...
namespace Sutoss.Controllers
{
    [Route("[controller]")]
    [ApiController]
    public class CuotaPrestamosController : ControllerBase
    {
        private readonly ILogger<CuotaPrestamosController> _logger;
        private readonly ICuotaPrestamosService _service;

        public CuotaPrestamosController(ILogger<CuotaPrestamosController> logger, ICuotaPrestamosService service)
        {
            _logger = logger;
            _service = service;
        }
