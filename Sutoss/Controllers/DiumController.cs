...
namespace Sutoss.Controllers
{
    ...
    public class DiaController : ControllerBase
    {
        ...
        public DiaController(ILogger<DiaController> logger, IDiaService service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        [HttpPost("Create")]
        [Authorize]
        public async Task<IActionResult> Create(DiumRequest newDium)
        {
            try 
            {
                return Ok(await _service.Create(newDium  ));
            }
            catch (NotFoundException ex)
            {
                // Logger.Warn(ex);
        ...
        [HttpPut("Update")]
        [Authorize]
        public async Task<IActionResult> Update(DiumRequest Dium)
        {
            try
            {
                return Ok(await _service.Update(Dium  ));
            }
            catch (NotFoundException ex)
            {
                // Logger.Warn(ex);
