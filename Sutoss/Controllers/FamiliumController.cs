...
namespace Sutoss.Controllers
{
    ...
    public class FamiliaController : ControllerBase
    {
        ...
        public FamiliaController(ILogger<FamiliaController> logger, IFamiliaService service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        [HttpPost("Create")]
        [Authorize]
        public async Task<IActionResult> Create(FamiliumRequest newFamilium)
        {
            try 
            {
                return Ok(await _service.Create(newFamilium  ));
            }
            catch (NotFoundException ex)
            {
                // Logger.Warn(ex);
        ...
        [HttpPut("Update")]
        [Authorize]
        public async Task<IActionResult> Update(FamiliumRequest Familium)
        {
            try
            {
                return Ok(await _service.Update(Familium  ));
            }
            catch (NotFoundException ex)
            {
                // Logger.Warn(ex);
