...
namespace Sutoss.Controllers
{
    ...
    public class CuotaController : ControllerBase
    {
        ...
        public CuotaController(ILogger<CuotaController> logger, ICuotaService service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        [HttpPost("Create")]
        [Authorize]
        public async Task<IActionResult> Create(CuotumRequest newCuotum)
        {
            try 
            {
                return Ok(await _service.Create(newCuotum  ));
            }
            catch (NotFoundException ex)
            {
                // Logger.Warn(ex);
        ...
        [HttpPut("Update")]
        [Authorize]
        public async Task<IActionResult> Update(CuotumRequest Cuotum)
        {
            try
            {
                return Ok(await _service.Update(Cuotum  ));
            }
            catch (NotFoundException ex)
            {
                // Logger.Warn(ex);
