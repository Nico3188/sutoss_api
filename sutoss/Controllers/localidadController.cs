...
namespace sutoss.Controllers
{
    ...
    public class localidadesController : ControllerBase
    {
        ...
        public localidadesController(ILogger<localidadesController> logger, IlocalidadesService service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        public async Task<IActionResult> Create(localidadRequest newlocalidad)
        {
            try 
            {
                ...
                return Ok(await _service.Create(newlocalidad, userId));
            }
            catch (NotFoundException ex)
            {
                // Logger.Warn(ex);
        ...
        public async Task<IActionResult> Update(localidadRequest localidad)
        {
            ...
            {
                string userId = KeyCloak.KeyCloakManager.GetExternalUserId(User);
                return Ok(await _service.Update(localidad, userId));
            }
            catch (NotFoundException ex)
            {
                // Logger.Warn(ex);
