...
namespace sutoss.Controllers
{
    ...
    public class PaymentsController : ControllerBase
    {
        ...
        public PaymentsController(ILogger<PaymentsController> logger, IPaymentsService service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        [HttpPost("Create")]
        [Authorize]
        public async Task<IActionResult> Create(PaymentRequest newAgreement)
        {
            try 
            {
        ...
        [HttpPut("Update")]
        [Authorize]
        public async Task<IActionResult> Update(PaymentRequest agreement)
        {
            try
            {
