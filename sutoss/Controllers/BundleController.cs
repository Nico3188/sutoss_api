...
namespace sutoss.Controllers
{
    ...
    public class BundlesController : ControllerBase
    {
        ...
        public BundlesController(ILogger<BundlesController> logger, IBundlesService service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        [HttpPost("Create")]
        [Authorize]
        public async Task<IActionResult> Create(BundleRequest newAgreement)
        {
            try 
            {
        ...
        [HttpPut("Update")]
        [Authorize]
        public async Task<IActionResult> Update(BundleRequest agreement)
        {
            try
            {
