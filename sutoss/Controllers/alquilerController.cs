...
namespace sutoss.Controllers
{
    ...
    public class alquileresController : ControllerBase
    {
        ...
        public alquileresController(ILogger<alquileresController> logger, IalquileresService service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        public async Task<IActionResult> Create(alquilerRequest newalquiler)
        {
            try 
            {
                ...
                return Ok(await _service.Create(newalquiler, userId));
            }
            catch (NotFoundException ex)
            {
                // Logger.Warn(ex);
        ...
        public async Task<IActionResult> Update(alquilerRequest alquiler)
        {
            ...
            {
                string userId = KeyCloak.KeyCloakManager.GetExternalUserId(User);
                return Ok(await _service.Update(alquiler, userId));
            }
            catch (NotFoundException ex)
            {
                // Logger.Warn(ex);
