...
namespace sutoss.Controllers
{
    ...
    public class UserRolesController : ControllerBase
    {
        ...
        public UserRolesController(ILogger<UserRolesController> logger, IUserRolesService service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        [HttpPost("Create")]
        [Authorize]
        public async Task<IActionResult> Create(UserRoleRequest newAgreement)
        {
            try 
            {
        ...
        [HttpPut("Update")]
        [Authorize]
        public async Task<IActionResult> Update(UserRoleRequest agreement)
        {
            try
            {
