...
namespace sutoss.Controllers
{
    ...
    public class PetsController : ControllerBase
    {
        ...
        public PetsController(ILogger<PetsController> logger, IPetsService service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        [HttpPost("Create")]
        [Authorize]
        public async Task<IActionResult> Create(PetRequest newAgreement)
        {
            try 
            {
        ...
        [HttpPut("Update")]
        [Authorize]
        public async Task<IActionResult> Update(PetRequest agreement)
        {
            try
            {
