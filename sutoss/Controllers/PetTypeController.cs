...
namespace sutoss.Controllers
{
    ...
    public class PetTypesController : ControllerBase
    {
        ...
        private readonly IPetTypesService _service;

        public PetTypesController(ILogger<PetTypesController> logger, IPetTypesService service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        [HttpPost("Create")]
        [Authorize]
        public async Task<IActionResult> Create(PetTypeRequest newAgreement)
        {
            try 
            {
        ...
        [HttpPut("Update")]
        [Authorize]
        public async Task<IActionResult> Update(PetTypeRequest agreement)
        {
            try
            {
