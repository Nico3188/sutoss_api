...
namespace sutoss.Controllers
{
    ...
    public class RolesController : ControllerBase
    {
        ...
        public RolesController(ILogger<RolesController> logger, IRolesService service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        [HttpPost("Create")]
        [Authorize]
        public async Task<IActionResult> Create(RoleRequest newAgreement)
        {
            try 
            {
        ...
        [HttpPut("Update")]
        [Authorize]
        public async Task<IActionResult> Update(RoleRequest agreement)
        {
            try
            {
