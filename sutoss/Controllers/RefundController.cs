...
namespace sutoss.Controllers
{
    ...
    public class RefundsController : ControllerBase
    {
        ...
        private readonly IRefundsService _service;

        public RefundsController(ILogger<RefundsController> logger, IRefundsService service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        [HttpPost("Create")]
        [Authorize]
        public async Task<IActionResult> Create(RefundRequest newAgreement)
        {
            try 
            {
        ...
        [HttpPut("Update")]
        [Authorize]
        public async Task<IActionResult> Update(RefundRequest agreement)
        {
            try
            {
