...
namespace sutoss.Controllers
{
    ...
    public class ServiceItemsController : ControllerBase
    {
        ...
        private readonly IServiceItemsService _service;

        public ServiceItemsController(ILogger<ServiceItemsController> logger, IServiceItemsService service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        [HttpPost("Create")]
        [Authorize]
        public async Task<IActionResult> Create(ServiceItemRequest newAgreement)
        {
            try 
            {
        ...
        [HttpPut("Update")]
        [Authorize]
        public async Task<IActionResult> Update(ServiceItemRequest agreement)
        {
            try
            {
