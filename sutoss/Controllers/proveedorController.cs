...
namespace sutoss.Controllers
{
    ...
    public class proveedoresController : ControllerBase
    {
        ...
        public proveedoresController(ILogger<proveedoresController> logger, IproveedoresService service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        public async Task<IActionResult> Create(proveedorRequest newproveedor)
        {
            try 
            {
                ...
                return Ok(await _service.Create(newproveedor, userId));
            }
            catch (NotFoundException ex)
            {
                // Logger.Warn(ex);
        ...
        public async Task<IActionResult> Update(proveedorRequest proveedor)
        {
            ...
            {
                string userId = KeyCloak.KeyCloakManager.GetExternalUserId(User);
                return Ok(await _service.Update(proveedor, userId));
            }
            catch (NotFoundException ex)
            {
                // Logger.Warn(ex);
